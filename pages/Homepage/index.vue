        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white">
                                ...
                                <h1 class="mt-30 mb-15">Burger</h1>
  ...
  <div class="container">
    ...
    <div class="row">
            <div class="col-sm-12">
                    <ul class="selecton brdr-b-primary mb-70">
                        ...
                        <li><a href="#" data-select="burger"><b>Burger</b></a></li>
                        <li><a href="#" data-select="burgerSanglier"><b>Burger Sanglier</b></a></li>
    ...
    <div class="row">
            <div class="col-md-6 food-menu pizza">
                ...
                <div class="s-left"><img class="br-3" src="/img/burger1.jpg" alt="Menu Image"></div><!--s-left-->
                <div class="s-right">
                        <h5 class="mb-10"><b>Burger Margherita</b><b class="color-primary float-right">$12.00</b></h5>
                        <p class="pr-70">Maecenas fermentum tortor id fringilla molestie. In hac habitasse platea dictumst. </p>
                </div><!--s-right-->
                </div><!-- sided-90x -->
            </div><!-- food-menu -->

            <div class="col-md-6 food-menu pizza burger">
                    <div class="sided-90x mb-30 ">
                            <div class="s-left"><img class="br-3" src="" alt="Menu Image"></div><!--s-left-->
                            <div class="s-right">
            ...
            <div class="col-md-6 food-menu burgerSanglier">
                    <div class="sided-90x mb-30 ">
                            <div class="s-left"><img class="br-3" src="" alt="Menu Image"></div><!--s-left-->
                            <div class="s-right">
                                    <h5 class="mb-10"><b>Burger Prosciuto</b><b class="color-primary float-right">$12.00</b></h5>
                                    <p class="pr-70">Maecenas fermentum tortor id fringilla molestie. In hac habitasse platea dictumst. </p>
                            </div><!--s-right-->
                    </div><!-- sided-90x -->
            </div><!-- food-menu -->
...
.bg-1 { background: url(img/banniereBurger.jpg) no-repeat center; background-size: cover; }
.h-700x {
